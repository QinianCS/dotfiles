-- /home/t/.config/koreader/settings/gestures.lua
return {
    ["custom_multiswipes"] = {},
    ["gesture_fm"] = {
    ...
    ["gesture_reader"] = {
        ...
        ["multiswipe_north_south"] = {
            ["settings"] = {
                ["order"] = {
                    [1] = "style_tweak_lineheight_all_inherit",
                    [2] = "style_tweak_padding_vertical_all_0",
                    [3] = "style_tweak_font_size_most_reset",
                    [4] = "style_tweak_font_family_all_inherit",
                    [5] = "style_tweak_font_size_all_inherit",
                    [6] = "style_tweak_margin_vertical_all_0",
                },
                ["show_as_quickmenu"] = true,
            },
            ["style_tweak_font_family_all_inherit"] = true,
            ["style_tweak_font_size_all_inherit"] = true,
            ["style_tweak_font_size_most_reset"] = true,
            ["style_tweak_lineheight_all_inherit"] = true,
            ["style_tweak_margin_vertical_all_0"] = true,
            ["style_tweak_padding_vertical_all_0"] = true,
        },
        ["multiswipe_north_south_north"] = {
            ["prev_chapter"] = true,
        },
